                ...
                <div>
                  <DropdownMenu>
                    <DropdownMenuTrigger className="w-full my-2">
                      <div className="h-full w-full relative flex items-center whitespace-nowrap rounded-md  dark:hover:bg-neutral-800 dark:hover:text-white hover:bg-neutral-200 hover:text-neutral-700 ">
                        {isSidebarExpanded ? (
